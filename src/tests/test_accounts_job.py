...
from jobs.accounts_job import (
    extract_accounts_data_from_source,
    extract_accounts_data_from_data_warehouse,
    rename_cols, 
    add_partition_cols, 
...
def test_extract_accounts_data_from_source(spark_session):

    df = extract_accounts_data_from_source(spark_session)

    assert df


def test_extract_accounts_data_from_data_warehouse(spark_session):

    df = extract_accounts_data_from_data_warehouse(spark_session)
...
def test_filter_to_latest_updated_records(spark_session):
